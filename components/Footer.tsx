...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#050816]/90 py-10 px-4 border-t border-gray-800">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              A passionate Full Stack Developer dedicated to creating beautiful and functional web applications with
              modern technologies.
            </p>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-500 text-sm">
          ...
          <p className="mt-2">
            Made with <span className="text-red-500">❤</span> and modern technologies.
          </p>
        </div>
      </div>
    </footer>
